...
//    private static final String PACKAGE_PATH_CONTROLLER = packageConvertPath(CONTROLLER_PACKAGE);//生成的Controller存放路径
    ...
    public static void genCode(String tag, String... tableNames) {
        for (String tableName : tableNames) {
            ...
            String packagePathController = packageConvertPath(BASE_PACKAGE + tag + ".web");
    ...
    public static void genController(String tableName, String tag, String packagePathController) {
        try {
            ...
            cfg.getTemplate("controller-user-bsicinfo.ftl").process(data, new FileWriter(file));
